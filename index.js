...
const client = new Client({
  phoneNumber: '218921550342', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
  ...
  // Owner 2
    { name: "geto", jid: "+201103345351@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 3
   { name: "mk", jid: "16838886639@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
