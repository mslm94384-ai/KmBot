...
const client = new Client({
  phoneNumber: '6285800568174', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "@lid", jid: "972569311531@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "@lid", jid: "201144480436@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "962776585115@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
