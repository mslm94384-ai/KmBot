...
const client = new Client({
  phoneNumber: '201156326496', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
  ...
  // Owner 3
    { name: "Sukuna", jid: "201156326496@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "201156326496@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
