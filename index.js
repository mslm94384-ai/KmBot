...
const client = new Client({
  phoneNumber: '0601052661', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "0601052661@lid", jid: "0601052661@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "0601052661@lid", jid: "0601052661@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "0601052661@s.whatsapp.net", lid: "0601052661@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "0601052661@s.whatsapp.net", lid: "0601052661@lid" }
  ],
