...
const menu =   ╭─┈─┈─┈─⟞🧛⟝─┈─┈─┈─╮   │ *نظام التفعيل والتشغيل*   │   │ *.تفعيل ايقاف_الترحيب*   │ > البوت هيبطل يرحب بالاعضاء   │   │ *.تفعيل تشغيل_الترحيب*   │ > البوت يرحب بالاعضاء   │   │ *.تفعيل تشغيل_الادمن*   │ > البوت يرد على المشرفين فقط   │   │ *.تفعيل ايقاف_الادمن*   │ > البوت يرد على الجميع   │   │ *.تفعيل مطور_فقط*   │ > البوت يتفاعل مع المطورين فقط   │   │ *.تفعيل مطور_عام*   │ > البوت يتفاعل مع الجميع   │   │ *.تفعيل تشغيل_مضاد_الروابط*   │ > البوت يحذف أي رابط   │   │ *.تفعيل ايقاف_مضاد_الروابط*   │ > البوت مايحذفش الروابط   │   │ *.تفعيل ايقاف_خاص*   │ > البوت هيشتغل مع المطورين فقط خاص   │   │ *.تفعيل تشغيل_خاص*   │ > البوت هيشتغل مع كله خاص   ╰─┈─┈─┈─⟞🧛⟝─┈─┈─┈─╯  ;
if (!subCmd) {
